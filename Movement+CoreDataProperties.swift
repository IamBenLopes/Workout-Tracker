...
extension Movement {
    ...
    @NSManaged public var movementLogs: Set<MovementLog>?
    @NSManaged public var splitDayMovement: Set<SplitDayMovement>?
    @NSManaged public var splitDays: Set<SplitDay>?
    @NSManaged public var muscleGroups: Set<MuscleGroup>?
}
